...
const uint8_t *NEGOTIATE_SECURITY_BLOB="\x60\x28\x06\x06\x2b\x06"   // ossia NEG_RESPONSE
  "\x01\x05\x05\x02\xa0\x1e\x30\x1c\xa0\x1a\x30\x18\x06\x0a\x2b\x06"
  "\x01\x04\x01\x82\x37\x02\x02\x1e\x06\x0a\x2b\x06\x01\x04\x01\x82"
  "\x37\x02\x02\x0a";
...
//				i=Receive(&myBuf,i /*sizeof(SMB2_NEGOTIATE_PROTOCOL)*/);
				...
				snr->BlobOffset=0x80;
				snr->BlobLength=42;
				snr->NegotiateContextoffset=0x204D4C20;		// LM 
...
//				i=Receive(&myBuf,i /*sizeof(SMB2_NEGOTIATE_PROTOCOL)*/);
		...
		//				i=Receive(&myBuf,i /*sizeof(SMB2_OPEN_SESSION)*/);
            ...
            if(asGuest) {
              ...
              stt1->boh[0]=0xa1; stt1->boh[1]=0x0c; stt1->boh[2]=0x06; stt1->boh[3]=0x0a;
              ...
              stt1->attribute[4].type=0x0007;   // Timestamp
              stt1->attribute[4].length=8;
              *(uint64_t*)&stt1->attribute[4].name=gettime(0);
              stt1->attribute[5].type=0;   // End of list
		...
		//				i=Receive(&myBuf,i /*sizeof(SMB2_OPEN_SESSION)*/);
            ...
            stt2->hdr[0]=0xa1; stt2->hdr[1]=0x1b;
